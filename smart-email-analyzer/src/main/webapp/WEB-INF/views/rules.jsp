        ...
        <div class="panel">
            <div class="panel-head">
                <div>
                    ...
                    <p class="muted-text">Example: <strong>email</strong> gets a positive urgency boost.</p>
                </div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/rules/sender" method="post" class="compact-form">
                <div class="form-field">
                    ...
                    <input id="senderEmail" type="email" name="senderEmail" placeholder="email" required>
                </div>
